    ...
    return (
        ...
        <div>
            ...
            <div className="w-1/6 bg-gray-100 p-4 float-right"
                ...
                <p className="font=bold text-red-500 mt-4">Chú ý: Bạn có thể click vào số thứ tự câu hỏi trong bài để chuyển đến câu hỏi mà bạn mong muốn</p>
            ...
            <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            {topic.questions?.map((question) => (
                                                <div key={question.id} id={question.id} className="pl-4 mb-2">
                                                    {isSubmitted && !userAnswers[question.id] && <p className="text-red-500">Câu hỏi này chưa được trả lời</p>}
                ...
                <button type="submit"
                    disabled={isButtonDisabled}
                    className="p-2 bg-[#33CCCC] text-white rounded cursor-pointer center">Nộp Bài
                </button>
            </form>
            <div>
                {isSubmitted && (
